...
import {
    BS_ICON_EYE_CLASS,
    BS_ICON_EYE_SLASH_CLASS,
} from "../../../../../shared/constants/bootstrap-icon-constants.js";

function flipSecretReveal(refs: { preEl: Instance; iconEl: Instance; btn: Instance }, revealed: boolean): void {
    ...
    const btn = button(
        {
            ...
            onClick: (e) => {
                e.stopPropagation();
                revealed = !revealed;
                flipSecretReveal({ preEl, iconEl, btn }, revealed);
            },
        },
        [iconEl],
    );
