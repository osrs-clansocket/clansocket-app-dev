...
import { clanAuditDb, clanDirPath, clanFlowsDb } from "../../../database/core/database.js";
import { CLAN_AUDIT_DB_FILE, CLAN_DB_FILE, CLAN_FLOWS_DB_FILE } from "../../../database/core/db-constants.js";
import { SCOPE_APP, SCOPE_CLAN, SCOPE_CLAN_AUDIT, SCOPE_CLAN_FLOWS, SCOPE_VAREZ, type Scope } from "./scope.js";
...
export function openScopeDb(scope: Scope): Database | null {
    ...
    if (scope.kind === SCOPE_CLAN_FLOWS) {
        return clanDbExists(scope.clanId, CLAN_FLOWS_DB_FILE) ? clanFlowsDb(scope.clanId) : null;
    }
